...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(pagos, [{
    ...
    value: function _renderbasedonQueryvalue() {
      ...
      if (this.state.queryval.user == undefined) {
        return __jsx("div", {
      ...
      else Object(_actions_userAction__WEBPACK_IMPORTED_MODULE_13__["_getUserbyid"])(this.state.noDocument).then(function (res) {
          _this3.setState({
            userdata: res[0],
            dataExist: true,
            noDocument: res[0].id_Document
          });
          ...
          return __jsx("div", {
            ...
            value: _this3.state.noDocument,
            onChange: _this3._handleNoDocChange,
            label: "Numero de Documento",
            __source: {
              fileName: _jsxFileName,
              lineNumber: 118
            ...
            variant: "contained",
            color: "primary",
            onClick: _this3._handleLoadUser.bind(_this3),
            __source: {
              fileName: _jsxFileName,
              lineNumber: 119
            },
...
//# sourceMappingURL=prestamos.js.5baf284506968ed706b5.hot-update.js.map