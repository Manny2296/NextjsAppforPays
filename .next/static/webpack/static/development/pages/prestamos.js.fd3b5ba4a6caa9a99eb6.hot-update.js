  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(pagos, [{
    ...
    value: function _handleLoadUser() {
      ...
      return Object(_actions_userAction__WEBPACK_IMPORTED_MODULE_15__["_getUserbyid"])(this.state.noDocument).then(function (res) {
        ...
        console.log("Userdata>" + _this2.state.userdata);
    ...
    value: function _renderbasedonQueryvalue() {
      console.log('RENDERRRS'); //console.log("fuck"+ this.state.userdata)

      var map = new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_2___default.a(_babel_runtime_corejs2_core_js_object_entries__WEBPACK_IMPORTED_MODULE_1___default()(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.state.userdata)));
      console.log('concha' + map.get('name'));
...
//# sourceMappingURL=prestamos.js.fd3b5ba4a6caa9a99eb6.hot-update.js.map