...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(pagos, [{
    ...
    value: function _handleNoDocChange(event) {//  this.setState({noDocument: event.target.value});
    }
  }, {
    key: "_handleLoadUser",
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            queryval = query.user, userdataprops = [], dataexistprops = false;
            _context.next = 16;
            break;
...
//# sourceMappingURL=prestamos.js.72340170c9dcf16da365.hot-update.js.map