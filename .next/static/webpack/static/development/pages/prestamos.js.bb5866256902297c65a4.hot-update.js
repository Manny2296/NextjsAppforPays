...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(pagos, [{
    ...
    value: function _renderbasedonQueryvalue() {
      ...
      var tableauFormaté = this.state.userdata.map(function (obj) {
        var rObj = {};
        rObj[obj.idusuario] = obj;
        return rObj;
      });
      console.log('concha' + tableauFormaté.name);
...
//# sourceMappingURL=prestamos.js.bb5866256902297c65a4.hot-update.js.map