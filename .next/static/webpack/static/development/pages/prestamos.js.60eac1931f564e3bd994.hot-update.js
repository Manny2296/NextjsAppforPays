  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(pagos, [{
    ...
    value: function _rendercardPrestamos() {
      ...
      if (this.state.dataExist) {
        if ((this.state.userdate !== undefined || this.state.userdate !== []) && this.state.userdata.prestamos !== null) return this.state.userdata.prestamos.map(function (prestamo) {
...
//# sourceMappingURL=prestamos.js.60eac1931f564e3bd994.hot-update.js.map