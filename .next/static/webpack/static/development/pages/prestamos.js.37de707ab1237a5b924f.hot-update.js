...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(pagos, [{
    ...
    value: function _renderbasedonQueryvalue() {
      ...
      var userarray = _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(this.state.userdata).map(function (index) {
        return _this3.state.userdata[index];
      });

      console.log('concha' + userarray);
...
//# sourceMappingURL=prestamos.js.37de707ab1237a5b924f.hot-update.js.map