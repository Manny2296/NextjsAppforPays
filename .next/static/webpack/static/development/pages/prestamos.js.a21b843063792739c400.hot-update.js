...
function (_Component) {
  ...
  function pagos(props) {
    ...
    _this.state = {
      ...
      noDocument: _this.props.noDocumentprops
    };
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(pagos, [{
    ...
    value: function _renderbasedonQueryvalue() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this._rendercardPrestamos())); //{}  <label>{this.state.userdata.name}</label>
    }
  }, {
    key: "_doclick",
...
pagos.getInitialProps = function (_ref) {
  ...
  if (query.user !== undefined) {
    Object(_actions_userAction__WEBPACK_IMPORTED_MODULE_13__["_getUserbyid"])(query.user).then(function (res) {
      datares = res[0];
      console.log(datares + "----_>");
    })["catch"](function (error) {
      return console.log(error);
    });
  }
  ...
  return {
    queryval: query,
    userdataprops: datares,
    dataExistprops: true // noDocumentprops: datares.id_Document
...
//# sourceMappingURL=prestamos.js.a21b843063792739c400.hot-update.js.map