...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_8__["default"])(pagos, _Component);

  function pagos(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(this, pagos);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_5__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__["default"])(pagos).call(this, props));
    _this.state = {
    ...
    _this._handleNoDocChange = _this._handleNoDocChange.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(pagos, [{
        ...
        return this.state.userdata.prestamos.map(function (prestamo) {
          return (// console.log("valor prestamo" + prestamo.prestamo_valor),
            __jsx("div", {
              ...
              __self: this
            }, __jsx(_material_ui_core_CardActionArea__WEBPACK_IMPORTED_MODULE_18__["default"], {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 56
              },
              ...
              __self: this
            }, "Share"), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_14__["Button"], {
              size: "small",
              color: "primary",
              __source: {
                fileName: _jsxFileName,
    ...
    value: function _renderbasedonQueryvalue() {
      console.log('RENDERRRS' + this.state.queryval); //console.log("fuck"+ this.state.userdata.name)
...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref) {
    var query, queryval, userdataprops;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (query.user == undefined) {
              ...
              queryval = query.user, userdataprops = [];
            } else {
              console.log("Render based on user " + query.user);

              Object(_actions_userAction__WEBPACK_IMPORTED_MODULE_16__["_getUserbyid"])(query.user).then(function (res) {
                console.log("------->" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(res[0]));
                queryval = query.user, userdataprops = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(res[0]);
              })["catch"](function (error) {
                return console.log(error);
              });
            }
...
//# sourceMappingURL=prestamos.js.95d02c48c8a5af69885c.hot-update.js.map